...
<fieldset style="background:#f5f5f5;width:50%">
<br><br>
	<?php
...
<table width="366" border="0" align="center">
  ...
  <tr>
    ...
    <td><label>
    <input class="form-control" name="m1" type="text" id="m1" onChange="return fnam()" readonly="readonly" value="<?php echo $mat['desc'];?>">
  ...
  <tr>
    ...
    <td width="192">
        ...
        <input  class="form-control"  name="m2" type="text" id="m2" onChange="return fnam()" readonly="readonly" value="<?php echo $mat['itemno'];?>">    </td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="Comic Sans MS"><strong>Price:</strong></font></div></td>
    <td><input class="form-control"name="m3" type="text" id="m3" onChange="return lnam()" readonly="readonly" value="Rs<?php echo $mat['price'];?>">  </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input class="form-control" name="t1" type="text" id="t1" onChange="return email()"></td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="Comic Sans MS"><b>&nbsp;Account No: </b> </font></div></td>
    <td><input class="form-control" name="t2" type="text" id="t2" onChange="return pass()"></td>
  </tr>
  <tr> <td><div align="center"><font size="+1" face="Comic Sans MS"><b>Mobile no: </b></font></div></td>
    <td><input class="form-control" name="t3" type="text" id="t3" onChange="return phone()"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input class="form-control" name="t6" type="text" id="t6" onChange="return coun()"></td>
  </tr>
  <tr>
