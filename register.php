...
<fieldset style="background:#f5f5f5;width:100%" border="1">
<br><br>
<form method="post" name="f1" onSubmit="return vali()">
<table width="450" border="0" align="center" style="padding: 2px;">
  ...
  <tr>
    <td><div  class="col-75" align="center"><font size="+1" face="Comic Sans MS"><strong>Last name:</strong></font></div></td>
  ...
  <tr>
    ...
    <center>
      <input name="sub" class="btn btn-primary" type="submit" id="sub" value="Create my Account">
    </center>
    </label></td>
    </tr>
