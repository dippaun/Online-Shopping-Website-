...
<div>
  <p><br/>
      <font face="Lucida Handwriting" size="+1" color="#996699">E-mail:</font><font face="Lucida Handwriting" size="+1" color="#009966"> Deeppaun123@gmail.com
      </font><font face="Lucida Handwriting" size="+1" color="#66CC66"><br>
      </font>
	   <br>
    <font color="#996699" size="+1" face="Lucida Handwriting">Address:    <font color="#009966">Rameshwar nagar, Patelwadi, Street no. - 5, Jamnagar </font></font></p>
  <p> <font color="#996699" size="+1" face="Lucida Handwriting">Talk to us:</font><font color="#006633" size="+1" face="Lucida Handwriting"> +91 8264377215</font><font size="+1"><br>
    <font color="#996699" face="Lucida Handwriting">Fax us at:</font></font> <font color="#006633" size="+1" face="Lucida Handwriting">+91 8264377215</font></p>
  <p>&nbsp;</p>
</div>
  ...
  <form method="post" name="f1" onSubmit="return vali()">
    <table width="288" border="0" align="center">
      <tr>
        ...
        <td width="161"><label>
          <input  class="form-control" name="t1" type="text" id="t1" onChange="return name()">
        </label></td>
      </tr>
      <tr>
        <td><font  color="#996699" size="+1" face="Comic Sans MS">Phone No: </font></td>
        <td><label>
        <input class="form-control"name="t2" type="text" id="t2" onChange="return phone()">
        </label></td>
      </tr>
      <tr>
        <td><font color="#996699" size="+1" face="Comic Sans MS">Email:</font></td>
        <td><label>
        <input class="form-control"name="t3" type="text" id="t3" onChange="return email()">
        </label></td>
      </tr>
      <tr>
        <td><font color="#996699" size="+1" face="Comic Sans MS">Sub:</font></td>
        <td><input  class="form-control"name="t4" type="text" id="t4" onChange="return subj()"></td>
      </tr>
      <tr>
        <td><font color="#996699" size="+1" face="Comic Sans MS">Message:</font></td>
        <td><label>
          <textarea class="form-control"  name="t5" id="text" ></textarea>
        </label></td>
      </tr>
	  <tr>
	  <td colspan="2"><center><input  class="btn btn-primary" name="sub" type="submit" value="Submit"></center>	  </td>
	  </tr> 
    </table>
